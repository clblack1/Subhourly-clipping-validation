...
if __name__ == "__main__":
	ssc = PySSC()
	print ('Current folder = \\ALXAPFS01/CBLACK$/Coding/PVSC_Code/NREL')
	print ('SSC Version = ', ssc.version())
	print ('SSC Build Information = ', ssc.build_info().decode("utf - 8"))
	ssc.module_exec_set_print(0)
	data = ssc.data_create()
	ssc.data_set_string( data, b'solar_resource_file', b'//ALXAPFS01/CBLACK$/SAM/Weather/NREL_vendor1_2020_hourly_given.csv' );
	...
	ssc.data_set_number( data, b'system_capacity', 299.94854399999997 )
	...
	ssc.data_set_number( data, b'subarray1_nstrings', 119 )
	ssc.data_set_number( data, b'subarray1_modules_per_string', 8 )
	ssc.data_set_number( data, b'subarray1_mppt_input', 1 )
	ssc.data_set_number( data, b'subarray1_tilt', 10 )
	ssc.data_set_number( data, b'subarray1_tilt_eq_lat', 0 )
	ssc.data_set_number( data, b'subarray1_azimuth', 165 )
	...
	ssc.data_set_number( data, b'subarray1_gcr', 0.01 )
	...
	ssc.data_set_number( data, b'cec_a_ref', 2.5800200000000002 )
	ssc.data_set_number( data, b'cec_adjust', 22.3781 )
	ssc.data_set_number( data, b'cec_alpha_sc', 0.0037908400000000002 )
	ssc.data_set_number( data, b'cec_beta_oc', -0.17616399999999999 )
	ssc.data_set_number( data, b'cec_gamma_r', -0.38600000000000001 )
	ssc.data_set_number( data, b'cec_i_l_ref', 6.1439399999999997 )
	ssc.data_set_number( data, b'cec_i_mp_ref', 5.7599999999999998 )
	ssc.data_set_number( data, b'cec_i_o_ref', 8.0500000000000006e-11 )
	ssc.data_set_number( data, b'cec_i_sc_ref', 6.1399999999999997 )
	ssc.data_set_number( data, b'cec_n_s', 96 )
	ssc.data_set_number( data, b'cec_r_s', 0.339337 )
	ssc.data_set_number( data, b'cec_r_sh_ref', 529.16099999999994 )
	ssc.data_set_number( data, b'cec_t_noct', 46 )
	ssc.data_set_number( data, b'cec_v_mp_ref', 54.700000000000003 )
	ssc.data_set_number( data, b'cec_v_oc_ref', 64.599999999999994 )
	...
	ssc.data_set_number( data, b'cec_module_length', 1.631 )
	...
	ssc.data_set_number( data, b'mppt_low_inverter', 330 )
	ssc.data_set_number( data, b'mppt_hi_inverter', 480 )
	ssc.data_set_number( data, b'inv_num_mppt', 1 )
	ssc.data_set_number( data, b'inv_snl_c0', -1.2700000000000001e-07 )
	ssc.data_set_number( data, b'inv_snl_c1', 5.2900000000000002e-06 )
	ssc.data_set_number( data, b'inv_snl_c2', 0.0011659999999999999 )
	ssc.data_set_number( data, b'inv_snl_c3', -0.00089300000000000002 )
	ssc.data_set_number( data, b'inv_snl_paco', 250000 )
	ssc.data_set_number( data, b'inv_snl_pdco', 259022.85939999999 )
	ssc.data_set_number( data, b'inv_snl_pnt', 75 )
	ssc.data_set_number( data, b'inv_snl_pso', 2064.5285640000002 )
	ssc.data_set_number( data, b'inv_snl_vdco', 370 )
	...
	ssc.data_set_number( data, b'inv_ds_paco', 250000 )
	ssc.data_set_number( data, b'inv_ds_eff', 96.840999999999994 )
	ssc.data_set_number( data, b'inv_ds_pnt', 75 )
	ssc.data_set_number( data, b'inv_ds_pso', 0 )
	ssc.data_set_number( data, b'inv_ds_vdco', 370 )
	...
	ssc.data_set_number( data, b'inv_snl_eff_cec', 96.840795013127874 )
	ssc.data_set_number( data, b'inv_pd_eff', 95 )
	ssc.data_set_number( data, b'inv_cec_cg_eff_cec', 96.636394489650158 )
	ssc.data_set_array_from_csv( data, b'grid_curtailment', b'\\ALXAPFS01/CBLACK$/Coding/PVSC_Code/NREL/grid_curtailment.csv');
